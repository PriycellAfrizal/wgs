    ...
    $(document).ready(function() {
        ...
        $('#kodeproduksi').on('change', function(e) {
           ...
           function showHistory(nosp) {
                    ...
                    $.ajax({
                      type: "POST",
                      url: "warehouse/get_Historyspimport.php", // Ganti dengan nama file PHP yang akan menghandle permintaan ini
                      data: {
                        nosp: nosp
                      },
  ...
  if (isValid) {
    ...
    $.ajax({
      type: "POST",
      url: "warehouse/savespimport.php", // Change this to your server-side script
...
function addRowToModal() {
    ...
    // Inisialisasi Select2
    initializeSelect2('#namabarang_' + rowCount, 'warehouse/get_namabarangimport.php', 'Cari nama barang...');
...
function deleteRow() {
    ...
    $(".namabarang").select2({
        ajax: {
            url: 'warehouse/get_namabarangimport.php',
            dataType: 'json',
            delay: 250,
            processResults: function(data) {
                console.log('Data from get_namabarangimport.php:', data); // Debugging line
                return {
                    results: data
                };
            },
